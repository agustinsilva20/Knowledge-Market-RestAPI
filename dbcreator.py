...
query_curso = "CREATE TABLE IF NOT EXISTS Curso (CursoID INT PRIMARY KEY AUTO_INCREMENT,ProfesorID INT,FOREIGN KEY (ProfesorID) REFERENCES Profesor(ProfesorID),Categoria VARCHAR(15),FrecuenciaSemanal INT,CantidadSemanas INT,Modalidad VARCHAR(15),Descripcion VARCHAR(200),Precio FLOAT);"
query_comentario = """
