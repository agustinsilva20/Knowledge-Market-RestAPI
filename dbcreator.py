...
query_profesor = "CREATE TABLE IF NOT EXISTS Profesor ( ProfesorID INT PRIMARY KEY AUTO_INCREMENT, Nombre VARCHAR(30),Correo VARCHAR(100),Telefono INT, PasswordHash VARCHAR(100));"
